...
| Design Change Request No. | 26_002 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 空管件 |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ |  |
| Whether the catalyst information is confirmed? / 催化剂信息是否确认？（物料号、图纸、SPEC） | 空管件 |
...
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） | A样件无需FEA |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ |  |
...
| 字段 | 内容 |
|---|---|
| DFMA & Sample production OPL? | 空管件，无需DFMA |
| DFMA状态 | 无需DFMA |
...
| 需求样品订单数量 | ENG-ATS: \_\_\_\_；PPS: \_\_\_\_；TCR3: \_\_\_\_ |
...
| Design / 设计工程师 | 卢青松 |  | 2026.1.28 |
| Check / 校对工程师 | 杨拓 |  | 2026.01.4 |
| Catalyst / 催化剂 |  |  |  |
| PUE / 采购 |  |  |  |
| PM / 项目经理 |  |  |  |
| TCR3 |  |  |  |
