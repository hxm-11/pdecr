...
| Version | 13 |
| Effective date | 2024-10-23th |
| Design Change Request No. | 24_123 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 测试样件 |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ | 测试样件 |
...
| 字段 | 内容 |
|---|---|
| Was this change confirmed with Purchasing (Supplier) for feasibility? Feedback from Supplier? / 变更后的零件，生产可行性供应商是否确认？反馈？ | ok |
| Influence on purchasing part delivery time? / 对采购件交货时间的影响？ | 无，提前备货 |
...
| 字段 | 内容 |
|---|---|
| DFMA & Sample production OPL? | 只更换催化剂，无需DFMA |
...
| 字段 | 内容 |
|---|---|
| 如果涉及以下情况需TCR3审核确认。不涉及则 NA | [ ] NA（不涉及）；TCR3 2024-107（如涉及） |
| 库存报废，金额 |  |
| 采购成本增加，金额 |  |
| 产成本增加，金额 |  |
...
| ENG-CV1 | （确认） |  |  |
| PUR | （确认） |  | 2024.10.24 |
| Department Manager TCR3 / TCR3部门负责人 | 谢友福 |  | 2024.10.29 |

![](images/916bad3334d64efe65a9891f2a8361fcf4cbcbd7ac81a086f1d824f766bfc264.jpg)
