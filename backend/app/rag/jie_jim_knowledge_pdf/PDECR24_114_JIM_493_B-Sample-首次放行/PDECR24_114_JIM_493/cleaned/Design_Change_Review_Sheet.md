...
| Design Change Request No. | 24_114 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 否 |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ | 否，标定样件 |
| Whether the catalyst information is confirmed? / 催化剂信息是否确认？（物料号、图纸、SPEC） | DOC新方案、SDPF、SCR/ASC都是量产 |
...
| If impact customer, whether get confirm from customer side? / 请说明影响和是否得到客户的确认？ | 客户已确认边界无问题 |
...
| 字段 | 内容 |
|---|---|
| Mechanical strength & Durability will be influenced? / 机械强度&可靠性影响？ | [ ] no / 否；[ ] yes / 是 |
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） | 除支架外结构强度风险低 |
...
| Does the change influence on purchasing cost? / 变更对采购成本的影响？ | [ ] increase / 增加，金额____；[x] decrease / 降低，金额____；[ ] no change / 不变 |
...
对生产影响降低原因：B样设计量产报价821.34

| 字段 | 内容 |
|---|---|
| Feedback from manufacturing engineer? / 生产制造装配是否影响，反馈？ |  |
| Influence on project & product delivery time? / 对项目&产品交货时间的影响？ |  |
| Influence on manufacturing cost? / 对产成本的影响？ | [ ] increase / 增加，金额____；[x] decrease / 降低，金额____；[ ] no change / 不变 |
...
| 字段 | 内容 |
|---|---|
| PM alignment? (Influence on project Timeline? Cost?) / 是否同意对项目时间和成本的影响？ | 张家区（确认） |
| 需求样品订单数量 |  |
...
| 角色 | 姓名 | 签名 | 日期 |
|---|---|---|---|
| Design Team Leader / 设计团队负责人 | 杨广拓 |  | 2024.12.19 |
| ENG-CV1 / 系统 | （确认） |  |  |
| Department Manager TCR3 / TCR3部门负责人 | 谢友福 |  | 2024.12.24 |
