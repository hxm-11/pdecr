...
| Design Change Request No. | 24_130 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 否，对性能无影响 |
...
| Does the change influence on purchasing cost? / 变更对采购成本的影响？ | [x] increase / 增加，金额 +800 CNY/set样件；[x] decrease / 降低，金额，量产成本不变；[ ] no change / 不变 |
...
成本增加原因：在02基础上修模，新增800CNY样件，量产成本不变

| 字段 | 内容 |
|---|---|
| Feedback from manufacturing engineer? / 生产制造装配是否影响，反馈？ |  |
| Influence on project & product delivery time? / 对项目&产品交货时间的影响？ |  |
| Influence on manufacturing cost? / 对生产成本的影响？ | [x] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[ ] no change / 不变 |
...
| PUR | （确认） |  | 2025.1.8 |
| Department Manager TCR3 / TCR3部门负责人 | 谢友福 |  | 2025.1.10 |
