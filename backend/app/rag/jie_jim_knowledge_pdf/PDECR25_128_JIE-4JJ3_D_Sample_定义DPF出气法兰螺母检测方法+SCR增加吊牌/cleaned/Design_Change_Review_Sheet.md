...
| Design Change Request No. | 25_128 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 对系统无影响 |
...
| If impact customer, whether get confirm from customer side? / 请说明影响和是否得到客户的确认？ | 模型无更改 |
...
| 字段 | 内容 |
|---|---|
| Mechanical strength & Durability will be influenced? / 机械强度&可靠性影响？ | [x] no / 否；[ ] yes / 是 |
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） |  |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ | 设计无变更 |
...
| 字段 | 内容 |
|---|---|
| Was this change confirmed with Purchasing (Supplier) for feasibility? Feedback from Supplier? / 变更后的零件，生产可行性供应商是否确认？反馈？ | 无影响。检测方法新增。 |
| Influence on purchasing part delivery time? / 对采购件交货时间的影响？ |  |
| 涉及到变更的零件，博世已出PR，供应商还未来得及生产的订单，是否已经通知供应商取消？ | [ ] no / 否；[ ] yes / 是 |
| Does the change influence on purchasing cost? / 变更对采购成本的影响？ | [ ] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[x] no change / 不变 |
...
| 字段 | 内容 |
|---|---|
| Feedback from manufacturing engineer? / 产制造装配是否影响，反馈？ | 沿用（样件阶段） |
| Influence on project & product delivery time? / 对项目&产品交货时间的影响？ |  |
| Influence on manufacturing cost? / 对生产成本的影响？ | [ ] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[x] no change / 不变 |
...
| RBC库存报废，金额 | [ ] 库存报废，金额\_\_\_\_ |
| 采购成本增加，金额 | [ ] 采购成本增加，金额\_\_\_\_ |
| 生产成本增加，金额 | [ ] 生产成本增加，金额\_\_\_\_ |

| 角色 | 签名 |
|---|---|
| Design Team Leader | 杨广拓 |
| ENG-CV1 |  |
| PUR | PUR ② 2026-1283 |
| TCR3 | RBCW/TCR |
...
| System SM-ENG-CV1 / 系统 | 谢友福 |  |  |
| Design / 设计工程师 | 马阳 |  | 2025.12.01 |
| Check / 校对工程师 | 杨广扣 |  | 2025.12.02 |
| Catalyst / 催化剂 |  |  |  |
| PUE / 采购 | 李岑 |  |  |
| PM / 项目经理 |  |  |  |
| TCR3 |  |  |  |
