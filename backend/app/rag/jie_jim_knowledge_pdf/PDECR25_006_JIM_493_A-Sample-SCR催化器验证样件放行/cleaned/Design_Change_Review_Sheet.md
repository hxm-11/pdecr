...
| Version | 13 |
| Effective date | 2025-02-07th |
| Design Change Request No. | 25_006 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 指定试样件，高性能催化剂 |
...
| Influence on manufacturing cost? / 对产成本的影响？ | [ ] increase / 增加，金额____；[ ] decrease / 降低，金额____；[x] no change / 不变（此轮只是样测） |
