...
| Version | 13 |
| Effective date | 2024-09-03th |
| Design Change Request No. | 24_093 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 初次样件放行、用于标定测试 |
...
| If impact customer, whether get confirm from customer side? / 请说明影响和是否得到客户的确认？ | 客户已校核完成 |
...
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） | A样无需FEA仿真 |
...
| 涉及到变更的零件，博世已出PR，供应商还未来得及生产的订单，是否已经通知供应商取消？ | [x] no / 否；[ ] yes / 是 |
...
| 字段 | 内容 |
|---|---|
| 如果涉及以下情况需TCR3审核确认。不涉及则 NA | [ ] NA（不涉及） |
| [ ]库存报废，金额 |  |
| [ ]采购成本增加，金额 |  |
| [ ]产成本增加，金额 |  |
...
| Department Manager TCR3 / TCR3部门负责人 | 谢友福 |  | 2024.10.12 |
