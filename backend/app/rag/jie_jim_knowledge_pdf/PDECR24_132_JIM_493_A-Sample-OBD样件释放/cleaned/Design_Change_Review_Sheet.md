...
| Version | 13 |
| Effective date | 2024-11-23th |
| Design Change Request No. | 24_132 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） |  |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ |  |
| Whether the catalyst information is confirmed? / 催化剂信息是否确认？（物料号、图纸、SPEC） | 减涂覆特定，考虑测试 catalyst |
...
| 字段 | 内容 |
|---|---|
| Interface & boundary (internal and customer) will be influenced? / 接口&边界（内部和客户）影响？ | yes / 是；no / 否 |
...
| 字段 | 内容 |
|---|---|
| Mechanical strength & Durability will be influenced? / 机械强度&可靠性影响？ | yes / 是；no / 否 |
...
| Influence on manufacturing cost? / 对生产成本的影响？ | [ ] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[ ] no change / 不变 |
...
| Design / 设计工程师 | 卢青松 |  | 2024.12.2 |
| Check / 校对工程师 | 杨抗 |  | 2024.12.23 |
| Catalyst / 催化剂 | 张汉泉 |  |  |
| PUE / 采购 |  |  |  |
| PUR |  |  |  |
| PM / 项目经理 |  |  |  |
