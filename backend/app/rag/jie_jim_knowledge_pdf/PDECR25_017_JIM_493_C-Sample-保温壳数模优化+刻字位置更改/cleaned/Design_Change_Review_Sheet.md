...
| Version | 13 |
| Effective date | 2025-03-31th |
| Design Change Request No. | 25_017 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 系统无影响 |
...
| If impact customer, whether get confirm from customer side? / 请说明影响和是否得到客户的确认？ | 客户已确认 |
...
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） | 结构强度影响低 |
...
| Influence on purchasing part delivery time? / 对采购件交货时间的影响？ | 无 |
| 涉及到变更的零件，博世已出PR，供应商还未来得及生产的订单，是否已经通知供应商取消？ | [ ] no / 否；[x] yes / 是 |
...
| 角色 | 姓名 | 签名 | 日期 |
|---|---|---|---|
| Design Team Leader / 设计团队负责人 | ENG-CV1 | 杨 |  |
| System SM-ENG-CV1 / 系统 |  | （OCR模糊） |  |
| Design / 设计工程师 | 卢青松 |  | 2025.4.1 |
| Check / 校对工程师 |  |  | 2025.4.1 |
| PUR / 采购 |  |  |  |
| PUE / 采购工程师 | 李亮岑 |  |  |
| TCR3 |  | 福 | 2025 |
