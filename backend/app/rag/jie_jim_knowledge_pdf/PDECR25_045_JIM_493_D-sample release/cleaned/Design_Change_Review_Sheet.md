...
| Version | 15 |
| Effective date | 2025-05-13th |
| Design Change Request No. | 25_045 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | ASPOC已完成 |
...
| If Yes, How to evaluate? Plan? / 如果是，请说明影响和如何评估，计划？（例如：仿真分析等） | 结构强度风险的无 |
...
| 4.2 Product FMEA-relevant / DFMEA | [ ] no / 否；[x] yes / 是 |  |
...
| 字段 | 内容 |
|---|---|
| 库存处理总体说明 | D样件放行，新零件不涉及库存（只针对涉及到已经生产过的零件变更，新放行零件和本条不相关） |
...
| 字段 | 内容 |
|---|---|
| Was this change confirmed with Purchasing (Supplier) for feasibility? Feedback from Supplier? / 变更后的零件，生产可行性供应商是否确认？反馈？ | 设计调整 |
| Influence on purchasing part delivery time? / 对采购件交货时间的影响？ |  |
| 涉及到变更的零件，博世已出PR，供应商还未来得及生产的订单，是否已经通知供应商取消？ | [ ] no / 否；[ ] yes / 是 |
| Does the change influence on purchasing cost? / 变更对采购成本的影响？ | [ ] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[ ] no change / 不变 |
...
| 字段 | 内容 |
|---|---|
| Feedback from manufacturing engineer? / 产制造装配是否影响，反馈？ | D样量产成体 |
| Influence on project & product delivery time? / 对项目&产品交货时间的影响？ |  |
| Influence on manufacturing cost? / 对产成本的影响？ | [ ] increase / 增加，金额\_\_\_\_；[ ] decrease / 降低，金额\_\_\_\_；[ ] no change / 不变 |
...
| 角色 | 姓名 | 签名 | 日期 |
|---|---|---|---|
| Design Team Leader / 设计团队负责人 | ENG-CV1 |  |  |
| System SM-ENG-CV1 / 系统 |  |  |  |
| Design / 设计工程师 | 卢青松 |  | 2025.5.14 |
| Check / 校对工程师 |  |  |  |
| Catalyst / 催化剂 |  |  |  |
| PUE / 采购 |  |  |  |
| PM / 项目经理 |  |  |  |
