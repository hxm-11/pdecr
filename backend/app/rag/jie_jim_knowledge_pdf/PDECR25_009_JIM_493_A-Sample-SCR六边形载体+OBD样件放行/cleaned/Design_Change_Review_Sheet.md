...
| Version | 13 |
| Effective date | 2025-04-28th |
| Design Change Request No. | 25_009 |
...
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 特殊样件（OBD件） |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ | NA |
| Whether the catalyst information is confirmed? / 催化剂信息是否确认？（物料号、图纸、SPEC） | DW3254技术估的OBD件 |
...
| Design / 设计工程师 | 卢青松 |  | 2025.4.29 |
| Check / 校对工程师 | 杨广拓 |  | 2025.04.29 |
| System / 系统工程师 | 沈伟波 |  |  |
| Catalyst / 催化剂 | 张以泉 |  |  |
| PUE / 采购 |  |  |  |
| PM / 项目经理 |  |  |  |
