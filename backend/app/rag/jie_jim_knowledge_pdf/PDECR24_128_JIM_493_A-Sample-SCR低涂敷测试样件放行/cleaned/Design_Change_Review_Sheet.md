...
| Version | 13 |
| Effective date | 2024-10-30th |
| Design Change Request No. | 24_128 |
...
| 字段 | 内容 |
|---|---|
| Function & Performance will be influenced? / 系统性能影响？ | [ ] yes / 是；[ ] no / 否 |
| If Yes, System impaction evaluation? / 如果是，系统影响评估？（如果是初次样件放行，空白处请说明样件目的） | 否，测试样件 |
| Whether need sample to test? Plan? / 是否需要样件进行验证？计划？ | 否 |
...
| 字段 | 内容 |
|---|---|
| Interface & boundary (internal and customer) will be influenced? / 接口&边界（内部和外部客户）影响？ | [ ] yes / 是；[x] no / 否 |
...
| 字段 | 内容 |
|---|---|
| Feedback from manufacturing engineer? / 制造装配是否影响，反馈？ |  |
...
| 字段 | 内容 |
|---|---|
| 如果涉及以下情况需TCR3审核确认。不涉及则 NA | TCR3 No. 2025-01208P7 |
| 库存报废，金额 |  |
| 采购成本增加，金额 |  |
| 生产成本增加，金额 |  |
...
| ENG-CV1  | （确认） |  |  |
| PUR | (确认) |  | 2024.12.2 |
| Department Manager TCR3 / TCR3部门负责人 | 谢友福 |  | 2025.01.08 |
